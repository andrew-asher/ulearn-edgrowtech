...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "U-Learn by EdGrow — Interactive past paper learning for Sri Lankan students" },
      { property: "og:description", content: "A digital education platform built for the new AI era — interactive past papers, explanations, bookmarks and AI tutor for Sri Lankan A/L students." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "U-Learn by EdGrow — Interactive past paper learning for Sri Lankan students" },
      { name: "twitter:description", content: "A digital education platform built for the new AI era — interactive past papers, explanations, bookmarks and AI tutor for Sri Lankan A/L students." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8004bac8-3852-413f-a4fd-72d422b5c633/id-preview-e0ef2653--72c8c0b6-0afd-41e6-8a26-3a302490a914.lovable.app-1779155430827.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8004bac8-3852-413f-a4fd-72d422b5c633/id-preview-e0ef2653--72c8c0b6-0afd-41e6-8a26-3a302490a914.lovable.app-1779155430827.png" },
    ],
    links: [
